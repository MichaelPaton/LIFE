...
var NRS = (function(NRS, $, undefined) {
	...
	$(".modal").on("hidden.bs.modal", function(e) {
		...
		var $feeInput = $(this).find("input[name=feeLIFE]");
		...
		if ($feeInput.length) {
			...
			$(this).find(".advanced_fee").html(NRS.formatAmount(NRS.convertToNQT(defaultFee)) + " LIFE");
		}
	...
	$("input[name=feeLIFE]").on("change", function() {
		var $modal = $(this).closest(".modal");

		var $feeInfo = $modal.find(".advanced_fee");

		if ($feeInfo.length) {
			$feeInfo.html(NRS.formatAmount(NRS.convertToNQT($(this).val())) + " LIFE");
		}
	});
