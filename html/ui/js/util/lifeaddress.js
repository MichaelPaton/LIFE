/*
    LIFE address class, extended version (with error guessing).

    Version: 1.0, license: Public Domain, coder: LifeChg (admin@lifechg.com).
*/

function LifeAddress() {
	...
	this.set = function(adr, allow_accounts) {
		...
		if (adr.indexOf('LIFE-') == 0) adr = adr.substr(4);
