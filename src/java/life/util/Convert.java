...
public final class Convert {
    ...
    public static String rsAccount(long accountId) {
        return "LIFE-" + Crypto.rsEncode(accountId);
    }
    ...
    public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws LifeException.NotValidException {
        if (numBytes > 3 * maxLength) {
            throw new LifeException.NotValidException("Max parameter length exceeded");
        }
    ...
    public static long parseLIFE(String life) {
        return parseStringFraction(life, 8, Constants.MAX_BALANCE_LIFE);
    }
