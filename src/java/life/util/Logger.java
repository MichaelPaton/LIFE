...
/**
 * Handle logging for the LifeCoin node server
 */
public final class Logger {
     ...
     * The life/conf/logging-default.properties and life/conf/logging.properties configuration
    ...
    static {
        ...
        System.setProperty("java.util.logging.manager", "life.util.LifeLogManager");
        if (!(LogManager.getLogManager() instanceof LifeLogManager)) {
            System.setProperty("java.util.logging.manager",
                    (oldManager != null ? oldManager : "java.util.logging.LogManager"));
        }
        if (! Boolean.getBoolean("life.doNotConfigureLogging")) {
            try {
        ...
        log = org.slf4j.LoggerFactory.getLogger(LifeCoin.class);
        enableStackTraces = LifeCoin.getBooleanProperty("life.enableStackTraces");
        enableLogTraceback = LifeCoin.getBooleanProperty("life.enableLogTraceback");
    ...
    public static void shutdown() {
        if (LogManager.getLogManager() instanceof LifeLogManager) {
            ((LifeLogManager) LogManager.getLogManager()).lifeShutdown();
        }
    }
