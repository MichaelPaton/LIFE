...
import life.db.DbVersion;

class LifeDbVersion extends DbVersion {
        ...
        switch (nextUpdate) {
            ...
            case 37:
                if (!Constants.isTestnet) {
                    apply("INSERT INTO peer (address) VALUES " + "('54.148.21.4')");
                } else {
                    apply("INSERT INTO peer (address) VALUES " + "('54.148.21.4')");
                }
                    /*apply("INSERT INTO peer (address) VALUES " +
                            "('37.59.121.207'), ('life.phukhew.com'), ('humanoide.thican.net'), ('108.170.40.4'), ('54.77.63.53'), " +
                            ...
                            "('node7.mynxtcoin.org'), ('80.86.92.139'), ('184.164.72.177'), ('life.hofhom.nl'), ('85.25.198.120'), " +
                            ...
                            "('95.24.83.220'), ('gunka.szn.dk'), ('80.153.101.190'), ('life.cybermailing.com'), ('54.200.116.75'), " +
                            ...
                            "('life.shscrypto.net'), ('46.246.44.104'), ('87.98.163.78'), ('155.133.19.33'), ('195.154.67.124'), " +
                            ...
                            "('life.alkeron.com'), ('96.251.124.95'), ('5.45.98.105'), ('life.sx'), ('76.176.198.6'), ('192.3.158.120'), " +
                            "('83.217.195.132'), ('107.170.164.129'), ('54.68.87.225'), ('sluni.szn.dk'), ('212.47.237.7'), " +
                            "('life.scryptmh.eu'), ('pakisnxt.no-ip.org'), ('85.214.155.115'), ('174.140.166.124'), ('190.10.9.166'), " +
                            ...
                            "('188.35.156.10'), ('node6.mynxtcoin.org'), ('67.212.71.171'), ('84.200.206.220'), ('node1.life.thican.net'), " +
                    ...
                    apply("INSERT INTO peer (address) VALUES " +
                            "('life.scryptmh.eu'), ('54.186.98.117'), ('178.150.207.53'), ('192.241.223.132'), ('node9.mynxtcoin.org'), " +
