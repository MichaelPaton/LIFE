...
public abstract class LifeException extends Exception {

    protected LifeException() {
        super();
    }

    protected LifeException(String message) {
        super(message);
    }

    protected LifeException(String message, Throwable cause) {
        super(message, cause);
    }

    protected LifeException(Throwable cause) {
        super(cause);
    }

    public static abstract class ValidationException extends LifeException {
