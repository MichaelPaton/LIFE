...
import static life.user.JSONResponses.LOCK_ACCOUNT;
...
public final class UnlockAccount extends UserServlet.UserRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req, User user) throws IOException {
        ...
        if (account == null) {
            ...
            int blockchainHeight = LifeCoin.getBlockchain().getLastBlock().getHeight();
            try (DbIterator<? extends Block> blockIterator = LifeCoin.getBlockchain().getBlocks(account, 0)) {
            ...
            try (DbIterator<? extends Transaction> transactionIterator = LifeCoin.getBlockchain().getTransactions(account, (byte) -1, (byte) -1, 0)) {
