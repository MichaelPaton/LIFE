...
import static life.http.JSONResponses.INCORRECT_DELIVERY_DEADLINE_TIMESTAMP;
import static life.http.JSONResponses.INCORRECT_PURCHASE_PRICE;
import static life.http.JSONResponses.INCORRECT_PURCHASE_QUANTITY;
import static life.http.JSONResponses.MISSING_DELIVERY_DEADLINE_TIMESTAMP;
...
public final class DGSPurchase extends CreateTransaction {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) throws LifeException {
        ...
        try {
            ...
            if (deliveryDeadline <= LifeCoin.getEpochTime()) {
