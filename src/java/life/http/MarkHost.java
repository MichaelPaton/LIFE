...
import life.peer.Hallmark;
import org.json.simple.JSONObject;
import org.json.simple.JSONStreamAware;

import javax.servlet.http.HttpServletRequest;

import static life.http.JSONResponses.INCORRECT_DATE;
import static life.http.JSONResponses.INCORRECT_HOST;
import static life.http.JSONResponses.INCORRECT_WEIGHT;
import static life.http.JSONResponses.MISSING_DATE;
import static life.http.JSONResponses.MISSING_HOST;
import static life.http.JSONResponses.MISSING_SECRET_PHRASE;
import static life.http.JSONResponses.MISSING_WEIGHT;
...
public final class MarkHost extends APIServlet.APIRequestHandler {
    ...
    JSONStreamAware processRequest(HttpServletRequest req) {
        ...
        try {
            ...
            if (weight <= 0 || weight > Constants.MAX_BALANCE_LIFE) {
