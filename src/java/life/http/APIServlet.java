...
import static life.http.JSONResponses.ERROR_INCORRECT_REQUEST;
import static life.http.JSONResponses.ERROR_NOT_ALLOWED;
import static life.http.JSONResponses.POST_REQUIRED;
...
public final class APIServlet extends HttpServlet {
    ...
    abstract static class APIRequestHandler {
        ...
        abstract JSONStreamAware processRequest(HttpServletRequest request) throws LifeException;
    ...
    private static final boolean enforcePost = LifeCoin.getBooleanProperty("life.apiServerEnforcePOST");
