...
final class JSONData {
    ...
    static JSONObject accountBalance(Account account) {
        ...
        if (account == null) {
            ...
            json.put("effectiveBalanceLIFE", "0");
            ...
            json.put("effectiveBalanceLIFE", account.getEffectiveBalanceLIFE());
    ...
    static JSONObject transaction(Transaction transaction) {
        ...
        json.put("confirmations", LifeCoin.getBlockchain().getHeight() - transaction.getHeight());
