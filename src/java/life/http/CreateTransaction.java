...
import static life.http.JSONResponses.FEATURE_NOT_AVAILABLE;
import static life.http.JSONResponses.INCORRECT_ARBITRARY_MESSAGE;
import static life.http.JSONResponses.INCORRECT_DEADLINE;
import static life.http.JSONResponses.INCORRECT_REFERENCED_TRANSACTION;
import static life.http.JSONResponses.MISSING_DEADLINE;
...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
    ...
    final JSONStreamAware createTransaction(HttpServletRequest req, Account senderAccount, long recipientId,
        ...
        try {
            Transaction.Builder builder = LifeCoin.getTransactionProcessor().newTransactionBuilder(publicKey, amountNQT, feeNQT,
        ...
        } catch (LifeException.NotYetEnabledException e) {
