...
public final class Constants {
    ...
    public static final long MAX_BALANCE_LIFE = 7000000000L;
    public static final long ONE_LIFE = 100000000;
    public static final long MAX_BALANCE_NQT = MAX_BALANCE_LIFE * ONE_LIFE;
    public static final long INITIAL_BASE_TARGET = 153722867;
    public static final long MAX_BASE_TARGET = MAX_BALANCE_LIFE * INITIAL_BASE_TARGET;
    public static final int MAX_ROLLBACK = LifeCoin.getIntProperty("life.maxRollback");
    static {
        if (MAX_ROLLBACK < 1440) {
            throw new RuntimeException("life.maxRollback must be at least 1440");
        }
    }
    ...
    public static final boolean isTestnet = LifeCoin.getBooleanProperty("life.isTestnet");
    public static final boolean isOffline = LifeCoin.getBooleanProperty("life.isOffline");
    ...
    static final long UNCONFIRMED_POOL_DEPOSIT_NQT = (isTestnet ? 50 : 100) * ONE_LIFE;
