...
public final class DebugTrace {
    ...
    static final String QUOTE = LifeCoin.getStringProperty("life.debugTraceQuote", "");
    static final String SEPARATOR = LifeCoin.getStringProperty("life.debugTraceSeparator", "\t");
    static final boolean LOG_UNCONFIRMED = LifeCoin.getBooleanProperty("life.debugLogUnconfirmed");

    static void init() {
        List<String> accountIdStrings = LifeCoin.getStringListProperty("life.debugTraceAccounts");
        String logName = LifeCoin.getStringProperty("life.debugTraceLog");
    ...
    private Map<String,String> lessorGuaranteedBalance(Account account, long lesseeId) {
        ...
        map.put("timestamp", String.valueOf(LifeCoin.getBlockchain().getLastBlock().getTimestamp()));
        map.put("height", String.valueOf(LifeCoin.getBlockchain().getHeight()));
    ...
    private Map<String,String> getValues(long accountId, Block block) {
        ...
        map.put("event", "block");
        map.put("effective balance", String.valueOf(Account.getAccount(accountId).getEffectiveBalanceLIFE()));
